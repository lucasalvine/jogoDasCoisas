...
$response = ""; 
	if(!isset($_SESSION['answer_array']) || count($_SESSION['answer_array']) < 1){
		$response = "Voce ainda nao tem perguntas cadastradas.";
		echo '
	...
	if(isset($_POST['complete']) && $_POST['complete'] == "true"){
		if(!isset($_POST['username']) || $_POST['username'] == ""){
			echo "Desculpe, temos um erro. Comece novamente";
			echo '
				<form action="index.php" method="">
				<br /><input type="submit" value="Voltar"/>
				</form>';
	...
	if(!in_array("1", $_SESSION['answer_array'])){
		...
		echo "Sua nota e $percent%";
		echo '
				<form action="index.php" method="">
				<br /><input type="submit" value="Inicio"/>
				</form>
				<form action="listaParticipantes.php" method="">
				<br /><input type="submit" value="Lista de Participantes"/>
				</form>';
	...
	VALUES ('$username', '$percent', now())")or die(mysql_error());
		echo "Obrigado por jogar conosco! Sua nota e: $percent%";
		echo '
				<form action="index.php" method="">
				<br /><input type="submit" value="Inicio"/>
				</form>
